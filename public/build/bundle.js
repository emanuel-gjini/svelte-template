...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Welcome to Home Page hello";
    			t1 = space();
    			t2 = text(/*currentDate*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-1pse5je");
    			add_location(h1, file$2, 4, 4, 66);
    			add_location(main, file$2, 3, 0, 55);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ currentDate });
    	return [currentDate];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Welcome to About us Page";
    			t1 = space();
    			t2 = text(/*currentDate*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-1pse5je");
    			add_location(h1, file$1, 4, 4, 66);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file, 9, 1, 198);
    			add_location(div, file, 14, 1, 273);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Link, Home, About, url });
